...
export const BOOKINGS: Booking[] = [
  ...
  },
  {
    ...
    price: "$525 + $15/pp",
    notes:
      "NOT YET BOOKED — no confirmation on file. Body weights. 2 planes for 6; confirm simultaneous departure.",
    planB:
      "AM primary, PM standby Jun 30 + Jul 1, final retry Jul 2 AM. After 3 attempts, refund.",
    confirmed: false,
  },
  {
    id: "transit-bus",
